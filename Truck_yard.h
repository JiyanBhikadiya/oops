...
class Truck_yard{
    ...
    public:
        ...
        bool addStock(Truck c); // tries to add a truck to yard. If there is enough space, return true and adds truck to the yard. Otherwise, do not save truck, and return false.
